...
<h2 class="text-2xl font-bold text-center my-4">Systems</h2>
<ul class="mt-2 mx-auto flex flex-wrap gap-3 justify-center w-11/12 sm:w-2/3">
	{@render listItem(
		["Surround Sound Systems", "Home Automation", "Flat Screen TVs", "Home Theater Systems", "Network/Phone/Data", "Distributed Audio Systems", "Dish + DirecTV", "Alarm/Surveillance", "Intercom Systems"]
	)}
</ul>
